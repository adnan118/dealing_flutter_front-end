...
//MultipartRequest
  postRequestWithFile(String url, Map data, File file) async {
    ...
    if (myrequest.statusCode == 200) {
      ...
      return null; // أو يمكنك إرجاع كائن يمثل الخطأ
    }
  }
  ...
  Future<List<dynamic>> fetchCountries() async {
    ...
    if (response.statusCode == 200) {
      ...
      // إعادة ترتيب القائمة بحيث تكون "Syria" أولاً
      countries.sort((a, b) {
        if (a['name']['common'] == 'Syria') {
          return -1; // تجعل "Syria" تأتي أولاً
        } else if (b['name']['common'] == 'Syria') {
          return 1; // تجعل "Syria" تأتي بعد الأول
        }
        return 0; // لا تغيير في ترتيب الدول الأخرى
      });
